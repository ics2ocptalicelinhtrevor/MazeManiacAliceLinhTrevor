...
local function Level1ScreenTransition( )
    composer.gotoScene( "instructions1", {effect = "slideLeft", time = 200})
end    
...
local function Level2ScreenTransition( )       
    composer.gotoScene( "instructions2", {effect = "slideRight", time = 200})
end 
...
-- Creating Transition to Level3 Instructions Screen
 ...
 local function Level3ScreenTransition( )
    composer.gotoScene( "instructions3", {effect = "slideLeft", time = 200})
end  
